...
namespace DEM.Project.Migrations
{
    ...
    [Migration("20200630073038_HiepTD")]
    partial class HiepTD
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEM.Project.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEM.Project.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DEM.Project.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEM.Project.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DEM.Project.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DEM.Project.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DEM.Project.Authorization.Roles.Role", b =>
                {
                    b.HasOne("DEM.Project.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("DEM.Project.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("DEM.Project.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
